<?php
/*
 * Squelette : squelettes/accesDem.html
 * Date :      Mon, 08 Apr 2013 17:05:01 GMT
 * Compile :   Mon, 08 Apr 2013 17:15:23 GMT (0.013s)
 * Boucles :   _ariane, _traductions, _article, _principale
 */ 
//
// <BOUCLE hierarchie>
//
function BOUCLE_arianehtml_9e9ccdf2250cad220172e81720debc8e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_traductionshtml_9e9ccdf2250cad220172e81720debc8e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	(calcul_exposer($Pile[$SP]['id_article'], 'id_article', $Pile[0], $Pile[$SP]['id_rubrique'], 'id_article', '')  ?
			...
			'') .
	'>&#91;' .
	(calcul_exposer($Pile[$SP]['id_article'], 'id_article', $Pile[0], $Pile[$SP]['id_rubrique'], 'id_article', '') ? '' : (	'<a href="spip.php?page=accesDem&id_article=' .
		$Pile[$SP]['id_article'] .
...
// <BOUCLE articles>
//
function BOUCLE_articlehtml_9e9ccdf2250cad220172e81720debc8e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
' .
(($t1 = BOUCLE_traductionshtml_9e9ccdf2250cad220172e81720debc8e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
<p class="traductions">
	' .
...
// <BOUCLE articles>
//
function BOUCLE_principalehtml_9e9ccdf2250cad220172e81720debc8e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'</a>' .
BOUCLE_arianehtml_9e9ccdf2250cad220172e81720debc8e($Cache, $Pile, $doublons, $Numrows, $SP) .
...
' .
BOUCLE_articlehtml_9e9ccdf2250cad220172e81720debc8e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
        </div>
...
((htmlentities($Pile[$SP]['lang'] ? $Pile[$SP]['lang'] : $GLOBALS['spip_lang']) == 'br') ? executer_balise_dynamique('LOGIN_PUBLIC',
	array(@$Pile[0]['url'],vider_url(urlencode_1738(generer_url_entite('12', 'article', '', '', true)))),
	array(''), $GLOBALS['spip_lang'],0):executer_balise_dynamique('LOGIN_PUBLIC',
	array(@$Pile[0]['url'],vider_url(urlencode_1738(generer_url_entite('15', 'article', '', '', true)))),
...
'
			...
			<div class="identification nouveau">
...
'<?php
	...
	\'skel\' => ' . argumenter_squelette('squelettes/accesDem.html') . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ');
	include _DIR_RESTREINT . "public.php";
?'.'>
...
//
// Fonction principale du squelette squelettes/accesDem.html.
//
function html_9e9ccdf2250cad220172e81720debc8e($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	...
	$connect = '';
	$page = BOUCLE_principalehtml_9e9ccdf2250cad220172e81720debc8e($Cache, $Pile, $doublons, $Numrows, $SP);

	return analyse_resultat_skel('html_9e9ccdf2250cad220172e81720debc8e', $Cache, $page, 'squelettes/accesDem.html');
}
